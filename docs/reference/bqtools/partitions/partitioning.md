...
_**Dependencies**_ | `bqtools.[region].get_date_partitions`, `bqtools-qb.[region].get_date_partitions`, `bqtools.[region].parse_resource_id`
...
_**Dependencies**_ | `bqtools.[region].get_date_partition_ids`, `bqtools-bq.[region].get_date_partitions`, `bqtools.[region].parse_resource_id`
...
_**Dependencies**_ | `bqtools.[region].get_date_partition_ids`, `bqtools-qb.[region].get_date_partitions`, `bqtools.[region].parse_resource_id`
